...
namespace NuGet.Services.Search.Test
{
    public class RelevanceTests : HttpTest
    {
        ...
        [InlineData("C++", @"cpp", 1, "PackageRegistration.Id")]
        [InlineData("C#", @"csharp", 3, "PackageRegistration.Id")]
        [InlineData("Breeze Client and Server (obsolete)", @"^Breeze\.WebApi(\..+)?$", 3, "PackageRegistration.Id")]
        [InlineData("identity mongodb", @"Identity.MongoDb", 3, "PackageRegistration.Id")]
        ...
        [InlineData("appinsights", @"Angular-AppInsights", 3, "PackageRegistration.Id")]
